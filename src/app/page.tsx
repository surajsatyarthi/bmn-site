      ...
      <section id="how-it-works" className="py-24 bg-gradient-to-b from-blue-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-4">
            ...
            <StepCard
              number="3"
              icon={<Handshake className="w-8 h-8" stroke="url(#brand-gradient)" />}
              title="Review & Connect"
              description="Review matched buyers, see their requirements, and express interest."
            />
            <StepCard
              number="4"
              icon={<Ship className="w-8 h-8" stroke="url(#brand-gradient)" />}
              title="Ship & Grow"
      ...
      <section className="py-24 bg-white border-y border-bmn-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <ValueCard
              icon={<ShieldCheck className="w-10 h-10" stroke="url(#brand-gradient)" />}
            ...
            />
            <ValueCard
              icon={<Zap className="w-10 h-10" stroke="url(#brand-gradient)" />}
            ...
            />
            <ValueCard
              icon={<Globe2 className="w-10 h-10" stroke="url(#brand-gradient)" />}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {PERFECT_FOR.map((item) => (
              <ValueCard
                key={item.title}
                icon={<item.icon className="w-10 h-10" stroke="url(#brand-gradient)" />}
                title={item.title}
...
function StepCard({
  ...
  return (
    <div className="bg-white rounded-xl border border-bmn-border p-8 shadow-sm hover:shadow-md transition-shadow relative">
      <div className="absolute top-4 right-6 text-6xl font-display font-bold text-gray-200 select-none">
        {number}
      </div>
      <div className="mb-6 relative z-10">{icon}</div>
      <h3 className="text-xl font-bold text-text-primary mb-3 relative z-10 font-display">
        {title}
      </h3>
...
function ValueCard({
  ...
  return (
    <div className="text-center p-6">
      ...
      <h3 className="text-xl font-bold text-text-primary mb-4 font-display">{title}</h3>
